	...
	<div class="container">
					...
					<div class="post-item small">
						<div class="row">
							<div class="col-sm-4 col-xs-3">
								<div class="img-thumb">
									<a href="/"><div class="fbt-resize" style="background-image: url(/public/images/img/img-4.jpg)"></div></a>
								</div>
							</div>
					...
					<div class="post-item small">
						<div class="row">
							<div class="col-sm-4 col-xs-3">
								<div class="img-thumb">
									<a href="/">
										<div class="fbt-resize" style="background-image: url(&#39;/images/img/img-31.jpg&#39;)"></div>
									</a>
								</div>
							</div>
							<div class="col-sm-8 col-xs-9 no-padding-left">
					...
					<div class="post-item small">
						<div class="row">
							<div class="col-sm-4 col-xs-3">
								<div class="img-thumb">
									<a href="/">
										<div class="fbt-resize" style="background-image: url(/public/images/img/img-3.jpg)"></div>
									</a>
								</div>
							</div>
							<div class="col-sm-8 col-xs-9 no-padding-left">
		...
		<div class="copyrights">
			<div class="row">
				<div class="col-md-6">
					<p>COPYRIGHT © 2020 try-hard.info</p>
				</div>
				<div class="col-md-6">
