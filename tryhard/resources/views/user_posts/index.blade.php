              ...
              <div class="col-sm-12">
                ...
                <tbody>
                    ...
                    <tr role="row" class="odd">
                        ...
                        <td>
                            <a href="{{ route('user_posts.show',Crypt::encrypt($post->id)) }}">
                        ...
                        <td>
                            <form style="display: -webkit-inline-box;" action="{{ route('user_posts.destroy',Crypt::encrypt($post->id)) }}" method="POST">
                                <a href="{{ route('user_posts.edit',Crypt::encrypt($post->id)) }}" class="btn btn-datatable btn-icon btn-transparent-dark mr-2">
                            ...
                            <form style="display: -webkit-inline-box;" action="{{ route('user_posts.publish',Crypt::encrypt($post->id)) }}" method="POST">
                                @csrf
                                <button class="btn btn-datatable btn-icon btn-transparent-dark">
